...
$pageHero = [
  'title'  => 'Ensino Médio',
  'sub'    => '1º ao 3º Ano. Preparação intensiva para vestibulares de elite e para o sucesso profissional.',
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.5)] overflow-hidden mb-12">
      ...
      <div class="p-8">
        ...
        <p class="text-white/60 mb-6">O Ensino Médio é a fase de preparação para o ensino superior e para o mercado de trabalho. Nosso foco é oferecer uma formação completa, com ênfase no desenvolvimento de competências essenciais para o século XXI, preparando os alunos para vestibulares e ENEM.</p>
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div class="text-center">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Vestibulares</h3>
            <p class="text-sm text-white/60">Preparação completa</p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-sm text-white/60">Inovação digital</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Orientação</h3>
            <p class="text-sm text-white/60">Carreira e futuro</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mb-12">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <p class="text-sm text-white/60">Literatura e redação</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <p class="text-sm text-white/60">Cálculo avançado</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <h3 class="font-semibold text-white/90 mb-2 font-poppins">Física</h3>
          <p class="text-sm text-white/60">Mecânica e termodinâmica</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <h3 class="font-semibold text-white/90 mb-2 font-poppins">Biologia</h3>
          <p class="text-sm text-white/60">Genética e ecologia</p>
        </div>
      </div>
    </div>
    ...
    <div>
      <h2 class="text-2xl font-bold text-white mb-6 font-poppins">Programas de Preparação</h2>
      <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          <div class="text-center mb-4">
            <div class="w-16 h-16 bg-indigo-500/20 rounded-full flex items-center justify-center mx-auto mb-3">
              <i class="fas fa-file-alt text-indigo-400 text-2xl"></i>
            </div>
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">ENEM</h3>
          </div>
          <p class="text-sm text-white/60 text-center">Preparação intensiva para o Exame Nacional do Ensino Médio</p>
        </div>
        
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          <div class="text-center mb-4">
            <div class="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-3">
              <i class="fas fa-university text-purple-400 text-2xl"></i>
            </div>
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Vestibulares</h3>
          </div>
          <p class="text-sm text-white/60 text-center">Simulados e preparação para principais universidades</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          <div class="text-center mb-4">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Carreira</h3>
          </div>
          <p class="text-sm text-white/60 text-center">Orientação vocacional e profissional</p>
        </div>
      </div>
    </div>
  </div>
