...
<section class="bg-gradient-to-br from-pink-500 via-pink-600 to-rose-700 py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center text-white">
      <h1 class="text-4xl md:text-5xl font-bold mb-4 font-poppins">Redes Sociais</h1>
      <p class="text-xl text-white/90">Siga-nos nas redes sociais</p>
    </div>
  </div>
</section>
...
<section class="py-16 bg-gray-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
      <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-800 mb-1 font-poppins">Facebook</h3>
            <p class="text-sm text-gray-600">@escola.oficial</p>
          </div>
        </div>
      ...
      <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-800 mb-1 font-poppins">Instagram</h3>
            <p class="text-sm text-gray-600">@escola.oficial</p>
          </div>
        </div>
        <a href="#" class="mt-4 block text-center btn-secondary text-sm">
      ...
      <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-800 mb-1 font-poppins">Twitter</h3>
            <p class="text-sm text-gray-600">@escola_oficial</p>
          </div>
        </div>
        <a href="#" class="mt-4 block text-center btn-secondary text-sm">
          <i class="fas fa-external-link-alt mr-2"></i>Visitar
      ...
      <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-800 mb-1 font-poppins">YouTube</h3>
            <p class="text-sm text-gray-600">Escola Oficial</p>
          </div>
        </div>
        <a href="#" class="mt-4 block text-center btn-secondary text-sm">
      ...
      <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-800 mb-1 font-poppins">LinkedIn</h3>
            <p class="text-sm text-gray-600">Escola Institucional</p>
          </div>
        </div>
        <a href="#" class="mt-4 block text-center btn-secondary text-sm">
          <i class="fas fa-external-link-alt mr-2"></i>Visitar
      ...
      <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-800 mb-1 font-poppins">WhatsApp</h3>
            <p class="text-sm text-gray-600">(11) 12345-6789</p>
          </div>
        </div>
        <a href="#" class="mt-4 block text-center btn-secondary text-sm">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
      <h2 class="text-2xl font-bold text-gray-900 mb-4 font-poppins">Por que nos seguir?</h2>
      <div class="grid md:grid-cols-3 gap-6">
        <div class="text-center">
          ...
          <h3 class="font-semibold text-gray-800 mb-2 font-poppins">Notícias</h3>
          <p class="text-sm text-gray-600">Acompanhe as últimas notícias da escola</p>
        </div>
        ...
        <div class="text-center">
          ...
          <h3 class="font-semibold text-gray-800 mb-2 font-poppins">Eventos</h3>
          <p class="text-sm text-gray-600">Fique por dentro dos eventos e atividades</p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-sm text-gray-600">Conecte-se com nossa comunidade escolar</p>
        </div>
      </div>
    </div>
  </div>
