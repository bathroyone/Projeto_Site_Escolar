...
<head>
    ...
    <title>Histórico da Instituição | Site da Escola</title>
                ...
                <div class="flex items-center gap-3">
                    <a href="index.php" class="flex items-center gap-2 group">
                        ...
                        <div class="hidden sm:block">
                            <span class="text-white font-bold text-xs tracking-wide">HISTÓRICO DA</span>
                            <span class="block text-amarelo-destaque font-extrabold text-sm">INSTITUIÇÃO</span>
                        </div>
                    </a>
                </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-gradient-to-r from-azul-principal to-verde-complementar rounded-3xl p-8 mb-12 text-center">
            <h1 class="text-3xl md:text-4xl font-display font-bold text-white mb-4">
                <i class="fas fa-landmark mr-3"></i>Histórico da Instituição
            </h1>
            <p class="text-white/90 text-lg max-w-2xl mx-auto">
                Conheça a trajetória e os marcos históricos da nossa escola.
            </p>
        </div>

        <!-- Linha do Tempo -->
        <div class="relative">
            <div class="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-azul-principal to-verde-complementar hidden md:block"></div>
        ...
        <div class="mt-16 grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white/5 border border-white/10 backdrop-blur-sm/10 backdrop-blur-sm rounded-2xl p-8 border border-white-20">
                ...
                <p class="text-gray-300 text-center">
                    Ser referência nacional em educação inovadora, reconhecida pela qualidade do ensino e pelo impacto positivo na comunidade.
                </p>
            </div>
        </div>
        ...
        <div class="mt-12 bg-white/5 border border-white/10 backdrop-blur-sm/10 backdrop-blur-sm rounded-2xl p-8 border border-white-20">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                <div class="text-center">
                    ...
                    <h3 class="text-white font-semibold mb-2">Excelência</h3>
                    <p class="text-gray-400 text-sm">Compromisso com a qualidade</p>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="text-white font-semibold mb-2">Respeito</h3>
                    <p class="text-gray-400 text-sm">Valorização da diversidade</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-gray-400 text-sm">Busca constante pelo novo</p>
                </div>
                <div class="text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-hand-holding-heart text-white text-2xl"></i>
                    </div>
                    <h3 class="text-white font-semibold mb-2">Solidariedade</h3>
                    <p class="text-gray-400 text-sm">Compromisso social</p>
                </div>
            </div>
        </div>
    </main>
