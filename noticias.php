...
<section class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center text-white">
      <h1 class="text-4xl md:text-5xl font-bold mb-4 font-poppins">Notícias e Comunicados</h1>
      <p class="text-xl text-white/90">Fique por dentro das últimas novidades da nossa escola</p>
    </div>
  </div>
</section>
...
<section class="py-16 bg-gray-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <?php if (!empty($noticias_destaque)): ?>
      <div class="mb-12">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 font-poppins">Destaques</h2>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all overflow-hidden">
              ...
              <div class="p-6">
                <div class="flex items-center gap-2 mb-3">
                  <span class="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs font-semibold">Destaque</span>
                  <span class="text-gray-500 text-xs"><?php echo date('d/m/Y', strtotime($noticia['data_publicacao'])); ?></span>
                </div>
                <h3 class="font-bold text-gray-800 text-lg mb-2 font-poppins"><?php echo htmlspecialchars($noticia['titulo']); ?></h3>
    ...
    <!-- Todas as Notícias -->
    <div>
      <h2 class="text-2xl font-bold text-gray-900 mb-6 font-poppins">Todas as Notícias</h2>
