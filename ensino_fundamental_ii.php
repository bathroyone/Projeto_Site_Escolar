<?php
$pageTitle = 'Ensino Fundamental II';
...
$pageHero = [
  ...
  'sub'    => '6º ao 9º Ano. Pensamento crítico, investigação científica e desenvolvimento da autonomia.',
  'icon'   => 'fas fa-atom',
  'accent' => '#7c3aed',
  'badge'  => 'Ensino',
];
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.5)] overflow-hidden mb-12">
      <div class="h-64 relative">
        <img src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1200&h=400&fit=crop" alt="Estudantes ensino fundamental II" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div class="text-center text-white drop-shadow-[0_4px_20px_rgb(0,0,0,0.3)]">
            <i class="fas fa-atom text-6xl mb-4"></i>
            <p class="text-2xl font-semibold font-poppins">6º ao 9º Ano</p>
          </div>
        </div>
      </div>
      <div class="p-8">
        <h2 class="text-2xl font-bold text-white mb-4 font-poppins">Nossa Proposta Pedagógica</h2>
        <p class="text-white/60 mb-6">O Ensino Fundamental II é a fase de consolidação do conhecimento e desenvolvimento do pensamento crítico. Nosso foco é preparar os alunos para o ensino médio, aprofundando os conteúdos das diversas áreas do conhecimento e estimulando a autonomia e responsabilidade.</p>
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div class="text-center">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Raciocínio</h3>
            <p class="text-sm text-white/60">Pensamento crítico</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Investigação</h3>
            <p class="text-sm text-white/60">Pesquisa científica</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Autonomia</h3>
            <p class="text-sm text-white/60">Responsabilidade pessoal</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mb-12">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <p class="text-sm text-white/60">Literatura e gramática</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <p class="text-sm text-white/60">Álgebra e geometria</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <p class="text-sm text-white/60">Física, química e biologia</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          ...
          <p class="text-sm text-white/60">Brasil e mundo</p>
        </div>
      </div>
    </div>
    ...
    <div>
      <h2 class="text-2xl font-bold text-white mb-6 font-poppins">Projetos e Atividades</h2>
      <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          <div class="text-center mb-4">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Robótica</h3>
          </div>
          <p class="text-sm text-white/60 text-center">Clube de robótica educacional</p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          <div class="text-center mb-4">
            ...
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Sustentabilidade</h3>
          </div>
          <p class="text-sm text-white/60 text-center">Projetos ambientais</p>
        </div>
        
        <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all">
          <div class="text-center mb-4">
            <div class="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-3">
              <i class="fas fa-theater-masks text-purple-400 text-2xl"></i>
            </div>
            <h3 class="font-semibold text-white/90 mb-2 font-poppins">Artes</h3>
          </div>
          <p class="text-sm text-white/60 text-center">Expressão artística e cultural</p>
        </div>
      </div>
    </div>
  </div>
